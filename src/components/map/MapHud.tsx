import { Layers, Flame, MapPin, BrainCircuit } from 'lucide-react'
...
const LAYER_BUTTONS: { id: MapLayer; icon: typeof Flame; label: string }[] = [
  ...
  { id: 'markers',   icon: MapPin,        label: 'MARKORER' },
  { id: 'prediction',icon: BrainCircuit,  label: 'PREDIKSJON' },
]
    ...
    <>
      ...
      >
        ...
        >
          ...
          <span
            className="hud-value tabular-nums ml-1.5"
